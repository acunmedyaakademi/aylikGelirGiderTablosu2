...
function handleMovieForm() {
  ...
  if (formObj.id !== "") {
    ...
    money.selectValue = formObj.selectValue;
...
function handleEditBtn(e) {
  ...
  document.querySelector('select[name = "selectValue"]').value = money.selectValue;
